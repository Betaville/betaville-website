	...
	//	$userJSON = file_get_contents($userRequest,0,null,null);
		...
		<div class='page-container'> 
			...
			<div class='projects'>
                ...
                <table border="0">
				<tr><td><img src='images\sorry.gif' height='100' width='100' style='background-color: #383838'></td>
				<td><input type='file' name="profilePicture" id="profilePicture" value="Upload Picture"></td></tr>
