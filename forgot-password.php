<?php 
/**  
 *  forgot-password File - A service file to implement forgot password functionality for the website
...
include('head.php');
	...
	if(isset($_GET['sentMail'])) {
		$passChangeRequest = SERVICE_URL.'?section=user&request=changeCode&email='.urlencode($_POST['email']).'&websiteUrl='.WEB_URL.'/forgot-password.php?newCode=';
	...
	<center><h2>Update Password</h2></center>
				...
				<form name="credentials" method="post" action="forgot-password.php?changed=true&code=<?php echo $code;?>">
	...
	<script type="text/javascript">	
		function validateEmail(){
			...
			var dotpos=x.lastIndexOf(".");
				...
				<center><div id="myDiv" style="display:none"><h2></h2></div></center>
				<div class="register-section" id="form" style="display:block">
				<form name="credentials" method="post" action='forgot-password.php?sentMail=true' onsubmit="return validateEmail()">
